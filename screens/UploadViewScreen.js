...
export default class HomeScreen extends React.Component {
  ...
  handleScroll(event) {
    ...
    this.setState({ scrollPosition: event.nativeEvent.contentOffset.y ? event.nativeEvent.contentOffset.y : 0 });
  }
